    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!cc.getChecked(request.getParameter("StartTime"))
                ...
                response.sendRedirect("MDFRequest.jsp?msg=Please enter all the required fields!");
            } else if(!cc.getChecked(request.getParameter("SMB")) &&
                        !cc.getChecked(request.getParameter("LE")) &&
                        !cc.getChecked(request.getParameter("PUB"))){
                response.sendRedirect("MDFRequest.jsp?msg=Please select at least one of target audience!");
            }else{
